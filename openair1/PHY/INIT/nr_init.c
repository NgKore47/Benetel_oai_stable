...
void nr_phy_config_request(NR_PHY_Config_t *phy_config)
{
  ...
  LOG_I(PHY , "dl_grid_size = %u , value : %u , scs_common_value : %u\n",gNB_config->ssb_config.scs_common.value,gNB_config->carrier_config.dl_grid_size[gNB_config->ssb_config.scs_common.value].value , gNB_config->ssb_config.scs_common.value);
  ...
  LOG_I(PHY, "dl_frequency.value : %u Mhz , dl_bw_khz : %u\n",gNB_config->carrier_config.dl_frequency.value, dl_bw_khz);
