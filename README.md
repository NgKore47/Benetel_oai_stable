# Benetel Testing Environment(F-release)
...
cd phy
cd /fhi_lib/lib/
WIRELESS_SDK_TOOLCHAIN=gcc RTE_SDK=~/dpdk-stable-20.11.9/ XRAN_DIR=~/Benetel_oai_stable/phy/fhi_lib make XRAN_LIB_SO=1
```
...
sudo ./nr-softmodem -O ~/Benetel_oai_stable/oran-conf/f_release_benetel550.conf --thread-pool 3,5,7,9,11,12,13,14
```
